...
def assign_model(model):
    if model == 'libritts_v1':
        ...
        tx_steps = 500000
        rx_steps = 500000
        encoder_checkpoint = os.path.join('AudioDec/exp', 'autoencoder', 'symAD_libritts_24000_hop300', f"checkpoint-{tx_steps}steps.pkl")
        decoder_checkpoint = os.path.join('AudioDec/exp', 'vocoder', 'AudioDec_v1_symAD_libritts_24000_hop300_clean', f"checkpoint-{rx_steps}steps.pkl") 
